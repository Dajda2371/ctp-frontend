    ...
    const renderTaskItem = ({ item }: { item: Task }) => {
        ...
        return (
            ...
            >
                ...
                <ThemedText style={styles.siteText} numberOfLines={1}>
                    <IconSymbol name="building.2.fill" size={12} color={theme.icon} /> {site?.name}
                </ThemedText>
            ...
            <View style={[styles.header, { backgroundColor: theme.secondary }]}>
                ...
                <View style={styles.searchContainer}>
                    ...
                    <TouchableOpacity style={styles.filterBtn}>
                        <IconSymbol name="filter" size={24} color="#fff" />
                    </TouchableOpacity>
                </View>
            </View>
